...
from metranova.processors.clickhouse.flow import BaseFlowProcessor, StardustFlowProcessor
...
class TestStardustFlowProcessor(unittest.TestCase):
    def setUp(self):
        self.mock_pipeline = MagicMock()
    ...
    def test_build_message_basic_structure(self):
        ...
        with patch.dict(os.environ, {
            ...
            processor = StardustFlowProcessor(self.mock_pipeline)
