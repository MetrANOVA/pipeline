...
class FlowEdgeOutput(BaseClickHouseOutput):
    ...
    def __init__(self):
        ...
        CREATE TABLE IF NOT EXISTS {self.table} (
            ...
            `src_scrireg_ref` Nullable(String),
    ...
    def _build_message(self, value: dict, msg_metadata: dict) -> dict:
        ...
        return {
            ...
            "dst_esdb_ipsvc_ref": self.redis_lookup_list(value.get("meta", {}).get("esdb", {}).get("dst", {}).get("service", {}).get("prefix_group_name", [])),
            ...
            "ifin_ref": self.redis_lookup(value.get("meta", {}).get("iface_in", {}).get("id", None)),
            "ifout_ref": self.redis_lookup(value.get("meta", {}).get("iface_out", {}).get("id", None)),
            ...
            "src_esdb_ipsvc_ref": self.redis_lookup_list(value.get("meta", {}).get("esdb", {}).get("src", {}).get("service", {}).get("prefix_group_name", [])),
