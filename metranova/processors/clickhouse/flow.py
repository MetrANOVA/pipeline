...
class FlowProcessor(BaseClickHouseProcessor):
    ...
    def build_message(self, value: dict, msg_metadata: dict) -> Iterator[Dict[str, Any]]:
        ...
        return [{
            ...
            "dst_esdb_ipsvc_ref": self.pipeline.cacher.lookup_list("meta_esdb_ipsvc", value.get("meta", {}).get("esdb", {}).get("dst", {}).get("service", {}).get("prefix_group_name", [])),
            ...
            "ifin_ref": self.pipeline.cacher.lookup("meta_if", value.get("meta", {}).get("iface_in", {}).get("id", None)),
            "ifout_ref": self.pipeline.cacher.lookup("meta_if", value.get("meta", {}).get("iface_out", {}).get("id", None)),
            ...
            "src_esdb_ipsvc_ref": self.pipeline.cacher.lookup_list("meta_esdb_ipsvc", value.get("meta", {}).get("esdb", {}).get("src", {}).get("service", {}).get("prefix_group_name", [])),
